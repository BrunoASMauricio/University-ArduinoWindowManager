...
struct CharacterBlockDictionary {
  unsigned char size;
  CBDictionaryElement inner[100];
};
CharacterBlockDictionary ScreenBlock = {17,{
	{"Blank",						{0x00,0x00,0x00,0x00,0x00,0x00}},
	{"UpperHorizontalLine",			{0x30,0x30,0x30,0x30,0x30,0x30}},
	{"LowerHorizontalLine",			{0x0c,0x0c,0x0c,0x0c,0x0c,0x0c}},
	{"LeftVerticalLine",			{0xff,0xff,0x00,0x00,0x00,0x00}},
	{"RightVerticalLine",			{0x00,0x00,0x00,0x00,0xff,0xff}},
	{"TopLeftCorner",				{0xff,0xff,0x30,0x30,0x30,0x30}},
	{"BottomLeftCorner",			{0xff,0xff,0x0c,0x0c,0x0c,0x0c}},
	{"TopRightCorner",				{0x30,0x30,0x30,0x30,0xf,0xff}},
	{"BottomRightCorner",			{0x0c,0x0c,0x0c,0x0c,0xff,0xff}},

  {"Bar",			{0xf1,0xf1,0xf1,0x00,0x00,0x00}},
...
CharacterBlockDictionary FontBlock = {95, {
...
*/
//Holder for what is currently on screen
bool ScreenScreen[64][128] ={0};

unsigned char* Get(CharacterBlockDictionary* Dict, char* Name, unsigned char symbol){
