...
const int KEYBOARD_CLK = 38;
const int KEYBOARD_DATA = 8;

/*
This library holds the base keyboard functions

!!!!!!!!!!!!!!!!!!!DISCLAIMER!!!!!!!!!!!!!!!!!!!
We did not create nor alter this library (besides adjusting the interrupts and removing a couple sections of the code that were unnecessary for this project)
This library is extremely complete, we did not add any comments to it.
The keymap is the british one.
Link to the code:
...
class PS2Keyboard {
  public:
     ...
     */
    static void begin(uint8_t dataPin, uint8_t irq_pin, const PS2Keymap_t &map = PS2Keymap_UK);
